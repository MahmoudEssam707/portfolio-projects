...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        filtered_df = spacex_df  # No need to filter if 'ALL' is selected
...
def update_scatter_chart(entered_site, payload_range):
    if entered_site == "ALL":
        ...
        fig = px.scatter(
            ...
            y='class',
            color='class',
            title="Payload Mass and Launch Success (All Sites)",
        ...
        fig = px.scatter(
            ...
            y='class',
            color='class',
            title=f"Correlation between Payload Mass and Launch Success at {entered_site}",
            labels={'Payload Mass (kg)': 'Payload Mass (kg)'}
        )
...
#3. Which payload range(s) has the highest launch success rate? 2k : 5k
#4. Which payload range(s) has the lowest launch success rate? 8k : 10k
